...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/devilxdz/sharaXmuisc",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/SharaXassociate")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/saraXsupport")
